...
class AddressSetDefaultContainer extends Component {
    static defaultProps = {
        addresses: []
    }
    ...
    render() {
        return (
            <div>
                <div className="sl-page-header-title">设置默认物流地址</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddressSetDefaultContainer);